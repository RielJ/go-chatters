...
func Login() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"h-[100vh] flex justify-center items-center\" hx-ext=\"response-targets\"><form hx-post=\"/api/login\" hx-trigger=\"submit\" hx-target-401=\"#login-error\" hx-target=\"#login-error\" hx-swap=\"innerHTML\" class=\"p-12 rounded-lg bg-gray-600 flex flex-col gap-4\"><h1>Login</h1><input type=\"text\" placeholder=\"Username\" id=\"username\" name=\"username\"> <input type=\"password\" placeholder=\"Password\" id=\"password\" name=\"password\"><div id=\"login-error\"></div><div class=\"\"><button class=\"px-4 py-2 bg-green-900 rounded-sm\" type=\"submit\">LOGIN</button></div><p>Don’t have an account yet? <a href=\"/register\">Register</a></p></form></div>")
